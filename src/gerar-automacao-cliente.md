...
inputs:
  - name: cliente
    required: true
    description: "Identificador do cliente ou projeto de entrega"
  - name: stack
    required: true
    description: "Stack alvo do codigo: playwright-ts, playwright-js, cypress-ts, python-pytest, selenium-java, selenium-csharp, robot-framework"
  - name: modulo
    required: false
    description: "Gera automacao apenas para o modulo informado"
  - name: saida
    required: false
    description: "Diretorio de saida. Default: clients/<id>/entregaveis/automacao/<stack>/"
  - name: padrao
    required: false
    description: "Padrao arquitetural: page-objects, screenplay ou keywords"
  - name: idioma
    required: false
    description: "Idioma dos nomes e comentarios: pt-BR ou en-US"
targets:
  claude:
    supported: true
  opencode:
