...
inputs:
  ...
  - name: stack
    required: true
    description: "Stack do pacote auditado"
  - name: pacote
    required: false
    description: "Diretorio do pacote. Default: clients/<id>/entregaveis/automacao/<stack>/"
  - name: modulo
    required: false
    description: "Audita apenas o modulo informado"
  - name: origem
    required: false
    description: "Identificador textual do run ou pacote de geracao"
targets:
  claude:
    supported: true
  opencode:
